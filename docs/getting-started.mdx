...
| [Pi](https://github.com/earendil-works/pi) CLI | The development agent; one full session per task — installed by the one-line installer (via npm); needs Node ≥ 22.19, which you provide | `pi --version` |
