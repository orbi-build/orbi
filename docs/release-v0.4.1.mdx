# v0.4.1 release (latest)

`v0.4.1` was published 2026-09-09T17:33:28Z as the GitHub Release [v0.4.1](https://github.com/orbi-build/orbi/releases/tag/v0.4.1) (release task: Issue #563).

## Tag state (verified against origin)

| Ref | Object | Points at |
|---|---|---|
| `v0.4.1` | annotated tag `4e7187989f299cd9a66c8338e7f97feb87f88555` | commit `aec697a77d0ca8811b182424dac2b75af96698e7` |
