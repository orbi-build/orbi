...
the integration duty is the system's, never the contributor's (Issue
#608).
...
3. When the delivery loop claims that triage Issue, it **reviews the
   ...
   branch, the merge gate and CI green apply unchanged). A PR that comes
   through review is merged, and merging it closes the triage Issue.
4. Only an abandoned, stale or unfixable PR is superseded by an internal
   ...
   Issue to the ready queue automatically.
