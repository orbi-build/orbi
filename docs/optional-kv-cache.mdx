---
description: "What does the optional local-llm-kv-cache proxy do for Orbi?"
---
# Optional: local-llm-kv-cache proxy

The optional proxy reuses stable prompt prefixes for local llama.cpp models while Orbi continues to use the same OpenAI-compatible endpoint.
