...
| [Pi](https://github.com/earendil-works/pi) CLI，需 Node ≥ 22.19.0 | 开发 agent；每个任务一个完整 session——安装命令：`npm install -g --ignore-scripts @earendil-works/pi-coding-agent` | `pi --version` |
