...
（2026-09-24 核对）列出两个 API 模型 id，均为 1M 上下文：
`deepseek-flash`（DeepSeek-V4.1-Flash）和 `deepseek-v4-pro`。仓库模板固定
`deepseek-flash`，`contextWindow` 131,072、`maxTokens` 16,384——正是 Orbi
自身交付自 **2026-09-22** 起使用的配置（截至 2026-09-24 合并的 20 次交付，例如
来源 Issue [#1328](https://github.com/orbi-build/orbi/issues/1328)）。
