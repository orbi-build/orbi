...
| OpenRouter 免费层 | `openrouter.json` | `OPENROUTER_API_KEY` | `google/gemma-3-27b-it:free` | 未实测；不承诺免费目录持续可用 | [#305](https://github.com/orbi-build/orbi/issues/305) |
| DeepSeek | `deepseek.json` | `DEEPSEEK_API_KEY` | `deepseek-chat` | 未实测 | [#305](https://github.com/orbi-build/orbi/issues/305) |
| xAI | `xai.json` | `XAI_API_KEY` | `grok-4.1-fast` | 已验证认证，但无额度：403 | [#305](https://github.com/orbi-build/orbi/issues/305) |
