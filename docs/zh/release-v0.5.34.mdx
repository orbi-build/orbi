...
`v0.5.34` 的 GitHub Release 发布说明：[v0.5.34](https://github.com/orbi-build/orbi/releases/tag/v0.5.34)（release task：Issue #1222）。

## Tag 状态（对 origin 验证）

| Ref | 对象 | 指向 |
|---|---|---|
| `v0.5.34` | 注解 tag `2872bdc3db106249a8dd72c34d8aa4418f989822` | 提交 `2476b13bbfa2f15aca2af78eeff9e2e5e90951e5` |
