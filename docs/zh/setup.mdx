...
cli=verified source=/path/to/checkout/src/muyan_pilot/__init__.py
...
setup_failed reason=checkout is not clean: /path/to/checkout (uncommitted changes: ' M src/muyan_pilot/runner.py') — commit or stash them first: ...
