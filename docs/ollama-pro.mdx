---
description: "How can I connect Orbi to Ollama Pro cloud models?"
---
# Ollama Pro cloud models

Connect Orbi to Ollama Pro through Pi’s custom provider file and Ollama’s OpenAI-compatible cloud endpoint, after verifying the account and model access.
