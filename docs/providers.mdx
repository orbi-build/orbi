...
(checked 2026-09-24) lists two API model ids with a 1M context,
`deepseek-flash` (DeepSeek-V4.1-Flash) and `deepseek-v4-pro`. The committed
template pins `deepseek-flash` with `contextWindow` 131,072 and `maxTokens`
16,384 — the exact block Orbi's own deliveries have run since **2026-09-22**
(the 20 deliveries merged between then and 2026-09-24, e.g. source Issue
